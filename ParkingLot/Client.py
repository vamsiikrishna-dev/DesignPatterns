...
from ChargeStrategy import DynamicChargeStrategy

if __name__ == '__main__':
    system = ParkingSystem.get_instance()
    system.set_payment(DynamicChargeStrategy())
    ...
    print(cost)
    ticket = system.park_vehicle(ParkingSlotType.MEDIUM, 'TS27PEK9409', datetime(2026,2,3,10))
    print(f"Ticket: {ticket}")
